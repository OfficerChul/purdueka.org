        ...
        <div className="w-[580px] mx-auto bg-white my-20">
            <form className="p-16" action="#" method="post">
                ...
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <input id="email" name="email" type="email" placeholder="이메일" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 ps-4 truncate" />
                </div>
                <label htmlFor="firstname" className="text-xl text-boilermaker-gold">First Name</label>
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <input id="firstname" name="fname" type="text" placeholder="이름" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 ps-4 truncate" />
                </div>
                <label htmlFor="lastname" className="text-xl text-boilermaker-gold">Last Name</label>
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <input id="lastname" name="lname" type="text" placeholder="성" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 ps-4 truncate" />
                </div>
                <label htmlFor="password" className="text-xl text-boilermaker-gold">Password</label>
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <input id="password" name="password" type="password" placeholder="비밀번호" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 ps-4 truncate" />
                </div>
                ...
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <input id="department" name="department" type="text" placeholder="e.g. Computer Science" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 ps-4 truncate" />
                </div>
                <label htmlFor="description" className="text-xl text-boilermaker-gold">Description</label>
                <div className="flex bg-gray-200 w-full rounded-full p-1 border border-boilermaker-gold border-2 mt-2 mb-8">
                    <select id="description" name="desc" className="w-full rounded-full bg-gray-200 focus:outline-none p-2 px-4 truncate me-2">
                ...
                <div className="flex justify-center">
                    <input type="submit" className="w-44 bg-boilermaker-gold text-white p-4 rounded-full min-w-fit mt-4 drop-shadow-md" value="회원가입" />
                </div>
            </form>
        </div>
      </div>
