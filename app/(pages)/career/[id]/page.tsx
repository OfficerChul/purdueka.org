  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex justify-between">
        <div className='text-2xl'><Link href="/career">채용공고</Link></div>
        {
          hasLoggedIn(user) &&
          data.authorId === user.id &&
          <div className='flex'>
            <button onClick={() => router.push(`/career/${params.id}/edit`)} className="bg-boilermaker-gold ms-4 py-2 px-4">수정하기</button>
